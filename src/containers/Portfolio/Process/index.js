      ...
      <Container noGutter mobileGutter width="1200px">
        ...
        <Box {...learningRow}>
          <Box {...learningContentArea}>
            {/* <Heading
              content="Which is why we Never Stop Innovating."
              {...learningTitle}
            /> */}
            {/* <Text
              content="We believe in the power of technology to transform and elevate businesses."
              {...learningSubTitle}
            /> */}
            {/* <Text
              {...learningDescription}
              content="I’m Jesse K. Lurie, a Costa Rican digital creator with expertise in web, mobile, and blockchain development. Over the course of my career, I have built a diverse portfolio that spans custom web development, mobile applications, and cutting-edge blockchain solutions."
            /> */}
            {/* <Text
              {...learningDescription}
              content="I've crafted user-centric digital experiences that enhance engagement and drive results. My work encompasses a broad range of services, including UI/UX design, ReactJS and AngularJS web applications, mobile apps using React Native, and blockchain technology with Substrate and Polkadot."
            /> */}
            {/* <Box {...buttonWrapper}>
