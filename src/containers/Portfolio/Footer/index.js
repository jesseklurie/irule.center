      ...
      <Container noGutter mobileGutter width="1200px">
        ...
        <Box {...row}>
          <Box {...col}>
            ...
            <Text
              as="span"
              content="irule.center © 2024 All rights reserved. "
              {...copyrightStyle}
            />
            <Link href="#">
              {' '}
              <Text as="span" content="irule center, Inc." {...copyrightStyle} />
            </Link>
          </Box>
          <Box {...col} {...flexBox}>
            <Box {...contactItem}>
              <Text content="Need help?" {...contactTitle} />
              <Text content="irule.center" {...contactInfo} />
            </Box>
            <Box {...contactItem}>
              <Text content="Feel like talking" {...contactTitle} />
              <Text content="+506-8695-9870" {...contactInfo} />
            </Box>
          </Box>
        </Box>
